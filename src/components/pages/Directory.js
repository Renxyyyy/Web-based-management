...
Geocode.setApiKey("AIzaSyCArljfHwjSWQGoeTKd7fnPbpVFEg-A3F4");
Geocode.enableDebug();
    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 1000 }}>
                ...
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyCArljfHwjSWQGoeTKd7fnPbpVFEg-A3F4&libraries=places"
                    loadingElement={
